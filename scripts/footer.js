    ...
    let footer = document.getElementById("footer").insertAdjacentHTML('afterbegin',`
        <footer id="footer_container" role="footer">
            ...
            <div class="img_container">
                <a href="https://validator.w3.org/check?uri=referer" target="_blank" class="w3_href">
            ...
            <div class="img_container">
                <a href="https://jigsaw.w3.org/css-validator?uri=referer" target="_blank" class="w3_href">
                    <picture class="w3_href_picture">
